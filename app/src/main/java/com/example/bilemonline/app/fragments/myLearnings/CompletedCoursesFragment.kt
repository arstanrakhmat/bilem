...
import com.example.bilemonline.databinding.FragmentCompletedCoursesBinding

class CompletedCoursesFragment : BaseFragment<FragmentCompletedCoursesBinding>() {
    ...
    override fun inflateView(
        ...
        container: ViewGroup?
    ): FragmentCompletedCoursesBinding {
        return FragmentCompletedCoursesBinding.inflate(inflater, container, false)
    }
